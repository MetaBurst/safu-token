...
contract Metaburst is IERC20 {
    ...
    string private constant _name = "Metaburst";
    string private constant _symbol = "MEBU";
    ...
    Fees public _taxRates =
        Fees({ buyFee: 300, sellFee: 300, transferFee: 300 });

    uint256 public constant maxBuyTaxes = 1500;
    uint256 public constant maxSellTaxes = 1500;
    uint256 public constant maxTransferTaxes = 1500;
    uint256 public constant maxRoundtripTax = 2000;
    ...
    address public marketingWallet =
        payable(0xFCF981A806680B587418F5fa9ae0E5cb415Ac164);
    ...
    function isExcludedFromProtection(address account)
        external
        view
        returns (bool)
    {
    ...
    function setExcludedFromProtection(address account, bool enabled)
        external
        onlyOwner
    {
    ...
    function setProtectionSettings(bool _antiSnipe, bool _antiBlock)
        external
        onlyOwner
    {
    ...
    function setWallet(address marketing) external onlyOwner {
    ...
    function takeTaxes(
        ...
        if (
            address(protections) == address(this) &&
